<?php
	...
	// add test results data
	 ...
	 echo '<a href="index.php?action=mod_user&uid=' . $_GET['uid'] . ' "><img src="' .ICONS_PATH . 'pencil.png" alt="Edit"/></a><br/>';
	...
	foreach($docRoot->childNodes as $child){
		...
		$link = '<a target="_blank" href="index.php?aq=lst_inGroup&id='.$nodeid.'">'.$groupsNameArr[$nodeid]."</a>";
		echo $link;
