<?php
	...
	<p><a href="index.php?action=mod_course_art&id=<?php echo $data['COURSE'] ?>">Back to Course</a></p>
	<p><a href="index.php?aq=newPage&aid=<?php echo $_GET['aid'] ?>">Add a New Page</a></p>
