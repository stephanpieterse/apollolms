<?php
	// ={userID}{courseID}{usernameFirst3Digits}{coursenameFirst3Digits}{random3digits}
	...
	$userReferenceNum = $userandcourse . substr($username,0,3) . substr($coursename,0,3) . mt_rand(100,999);//substr(hash("sha256",$userandcourse),0,3);
...
Once you have completed the payment, please submit the captcha. <br/>
...
<a href="" onclick="document.getElementById('captcha').src = '/scripts/securimage/securimage_show.php?' + Math.random(); return false;">[ Different Image ]</a>
