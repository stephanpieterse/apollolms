...
?>
<form method="post" action="/sitesettings.php?update=bank_details">
<table class="centerfloat">
<tr><td>Account Number:</td>
<td><input type="text" name="bank_accountnumber" value="<?php if(isset($xmldata)){echo xmlGetSpecifiedNode($xmldata, array('tagname'=>'bank_accountnumber','value'=>''))['value'];} ?>" /></td></tr>
<tr><td>Bank:</td>
...
<td><select class="fullWidth" name="bank_accounttype">
	...
	if(isset($xmldata)){
			$curAcc = xmlGetSpecifiedNode($xmldata, array('tagname'=>'bank_accounttype','value'=>''))['value'];
		}
...
<td><input type="text" name="bank_branchcode" value="<?php if(isset($xmldata)){echo xmlGetSpecifiedNode($xmldata, array('tagname'=>'bank_branchcode','value'=>''))['value'];} ?>" />
