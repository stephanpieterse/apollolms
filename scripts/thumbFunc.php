<?php
include(CLASS_PATH . 'zubarg_img.php');
...
function saveThumb($from_name, $to_name, $max_x = 100, $max_y = 100, $image_quality = 100, $image_type = -1, $save_to_file = true){
...
//if (!file_exists($images_folder)) { mkdir($images_folder, 0777);}//die('Images folder does not exist (update $images_folder in the script)');
//if ($save_to_file && !file_exists($thumbs_folder)) { mkdir($thumbs_folder, 0777);}// die('Thumbnails folder does not exist (update $thumbs_folder in the script)');
